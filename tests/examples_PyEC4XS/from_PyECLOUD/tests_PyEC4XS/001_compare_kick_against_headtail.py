...
OUTPUT_DIR = ensure_output_dir(SCRIPT_DIR / "output" / "001_compare_kick_against_headtail")
...
def main():
    ...
    generation_ring = build_sps_ring("Q20-injection", n_segments=1)
    ...
    initial_snapshot = snapshot_reference_particles(bunch, n_reference_particles)
    ...
    for turn_idx in range(n_turns - 1):
        ...
        actual_dx = after["px"] - initial_snapshot["px"]
        actual_dy = after["py"] - initial_snapshot["py"]
